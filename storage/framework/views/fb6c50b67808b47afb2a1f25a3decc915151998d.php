...
<html lang="en">
   <head>
      ...
      <title>PMS - <?php echo $__env->yieldContent('title'); ?> </title>
      <!-- Custom styles for this template-->
      <link href="<?php echo e(asset('css/app.css')); ?>" rel="stylesheet">
      <script src="https://kit.fontawesome.com/746a0dfe39.js" crossorigin="anonymous"></script>
         ...
         <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
               ...
               <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo e(route('home')); ?>">
                  ...
                  <div class="sidebar-brand-text mx-3">PMS SYSTEM</div>
               </a>
               <!-- Divider -->
               ...
               <li class="nav-item">
                  ...
                  <div id="collapsePatient" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                     <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?php echo e(route('patient.create')); ?>"><?php echo e(__('Nuevo Paciente')); ?></a>
...
</html><?php /**PATH D:\xampp\htdocs\PMS\resources\views/layouts/master.blade.php ENDPATH**/ ?>